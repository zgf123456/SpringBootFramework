package com.fastdev.jeesite.business.gen.service;

import com.fastdev.jeesite.business.gen.dao.GenDataBaseDictDao;
import com.fastdev.jeesite.business.gen.dao.GenTableColumnDao;
import com.fastdev.jeesite.business.gen.dao.GenTableDao;
		...
		if (StringUtils.isNotBlank(genTable.getName())){
			...
			if (list.size() > 0){
				...
				if (StringUtils.isBlank(genTable.getId())){
					...
					genTable.setClassName(StringUtilsExt.toCapitalizeCamelCase(genTable.getName()));
				}
