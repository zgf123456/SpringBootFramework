package com.fastdev.jeesite.business.gen.util;

import com.fastdev.jeesite.business.gen.entity.*;
...
import com.fastdev.jeesite.common.mapper.JaxbMapper;
import com.fastdev.jeesite.common.utils.DateUtils;
import com.fastdev.jeesite.common.utils.FileUtils;
import com.fastdev.jeesite.common.utils.FreeMarkers;
...
public class GenUtils {
	...
	public static void initColumnField(GenTable genTable){
		for (GenTableColumn column : genTable.getColumnList()){
			...
			// 设置java字段名
			column.setJavaField(StringUtilsExt.toCamelCase(column.getName()));
...
//		}
	...
	public static String generateToFile(GenTemplate tpl, Map<String, Object> model, boolean isReplaceFile){
		// 获取生成文件
		String fileName = Global.getConfig("gen.filePath") + File.separator
